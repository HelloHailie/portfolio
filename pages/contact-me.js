      ...
      <section className='text-gray-600 body-font'>
        <div className='container px-5 py-24 mx-auto flex flex-wrap justify-center'>
          ...
          <div className='flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center'>
            <div className='flex mb-5 items-center lg:flex-row flex-col'>
              ...
              <div className='ml-10 flex-grow'>
                ...
                >
                  <h2
                    className='text-gray-900 font-medium text-2xl hover:underline transition duration-300 transform 
              ...
              <div className='ml-10 flex-grow'>
                ...
                >
                  <h2
                    ...
                    hover:scale-[1.02] hover:text-violet-600  dark:hover:text-violet-400'
                  >
                    https://shinystarforever.tistory.com/
                  </h2>
                </a>
              </div>
            </div>
              ...
              <div className='ml-10 flex-grow'>
                ...
                >
                  <h2
                    ...
                    hover:scale-[1.02] hover:text-violet-600 dark:hover:text-violet-400'
                  >
                    https://www.linkedin.com/in/seonmin-lee-005a71246/
                  </h2>
                </a>
              </div>
            </div>
