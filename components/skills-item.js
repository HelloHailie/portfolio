...
const frontSkillsItem = [
  ...
  [
    <Image src={zustand} alt='zustand image' width={50} height={50} />,
    "Zustand",
...
const etcSkillsItem = [
  ...
  [<Discord />, "Discord", "디스코드를 이용한 소통, 협업 경험이 있습니다."],
  [
    <Notion />,
    "Notion",
    "노션을 통한 프로젝트 일정 관리와 회의록 작성을 하여 팀 문서를 정리한 경험이 있습니다.",
  ],
  [<Aws />, "AWS", "AWS S3을 통한 프로젝트 배포 경험이 있습니다."],
  [<Vercel />, "Vercel", "Vercel을 통한 프로젝트 배포 경험이 있습니다."],
];
